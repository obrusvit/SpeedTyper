// dear imgui, v1.75
// (demo code)
// obrusvit: modified to not contain ImGui::Image, it somehow does not work with SFML
...
static void ShowDemoWindowWidgets()
{
    ...
    if (ImGui::TreeNode("Images"))
    {
        ...
        ImVec2 pos = ImGui::GetCursorScreenPos();
        ImGui::Text("There was supposed to be image (line 816)");
        ...
        if (ImGui::IsItemHovered())
        {
            ...
            ImGui::Text("There was supposed to be image (line 829)");
        ...
        for (int i = 0; i < 8; i++)
        {
            ...
            ImGui::Text("There was supposed to be Image (line 837) ");
    ...
    if (ImGui::BeginTabBar("##tabs", ImGuiTabBarFlags_None))
    {
        ...
        if (ImGui::BeginTabItem("Fonts"))
        {
            ...
            if (ImGui::TreeNode("Atlas texture", "Atlas texture (%dx%d pixels)", atlas->TexWidth, atlas->TexHeight))
            {
                ...
                ImGui::Text("There was supposed to be Image (line 3490) ");
